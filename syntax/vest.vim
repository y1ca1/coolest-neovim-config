...
syntax keyword vestKeyword const let wrap choose apply Option Vec Vec1 Tail secret
...
" forbidden keywords (rust reserved keywords except for `const` and `let`)
syntax keyword vestForbidden abstract alignof as become box break continue crate do else enum extern false
